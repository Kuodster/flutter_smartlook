...
class SmartlookPreferences {
  ...
  /// Whether to use Android Jobs instead of internal logic - android only.
  Future<void> setJobUploadEnabled(bool value) async {
    await Channels.channel.invokeMethodOnMobile<void>('setJobUploadEnabled', {
      "doUpload": value,
    });
  }
